...
ActiveRecord::Schema.define(:version => 20130323183740) do
  ...
  create_table "bcms_my401k_library_article_versions", :force => true do |t|
    t.integer  "original_record_id"
    t.integer  "version"
  ...
  create_table "bcms_my401k_library_articles", :force => true do |t|
    t.integer  "version"
    t.integer  "lock_version",  :default => 0
    t.integer  "section_id"
    t.integer  "layout_id"
